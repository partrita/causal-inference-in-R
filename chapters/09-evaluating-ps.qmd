...
The problem is that we are more likely to remove well-matched pairs than to maintain balance.
...
Second, if we start to see that a caliper is too stringent and is worsening balance, we can simply use a less strict caliper.
